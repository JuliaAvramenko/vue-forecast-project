...
<template>
     <div class="summary">
        <div
          :style="`background-image: url('./weather-main/${weatherInfo?.weather && weatherInfo?.weather.length > 0 && weatherInfo?.weather[0].description}.png');`"
          class="pic-main"
        ></div>
        <div class="weather">
          <div class="temp">
          ...
          <div class="weather-desc text-block">
              {{ capitalizeFirstLetter(weatherInfo?.weather && weatherInfo?.weather.length > 0 && weatherInfo?.weather[0].description) }}
          </div>
        </div>
